set -e # I do not like these vscode extensions:
code --uninstall-extension streetsidesoftware.code-spell-checker --force 
code --uninstall-extension xirider.livecode --force
...
code --uninstall-extension ms-vscode.test-adapter-converter --force 
code --uninstall-extension traBpUkciP.wolf --force
...
code --install-extension yohan-pg.nvidia-smi-memory
code --install-extension ms-vscode.cpptools
code --install-extension ms-vscode.cpptools-extension-pack
code --install-extension REditorSupport.r
code --install-extension matthiasschedel.bibtex-manager
